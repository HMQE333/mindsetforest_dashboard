    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          {/* Tabs */}
          <div className="inline-flex items-center gap-2 p-1.5 rounded-2xl bg-muted/50 backdrop-blur-lg border border-white/10">
            <button
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl text-sm font-bold text-muted-foreground hover:text-foreground transition-all duration-300"
            >
              📊 Stats Tracker
            </button>
          </div>
        ...
        {activeTab === "dashboard" && (
          user ? (
            ...
            >
              <p className="text-muted-foreground mb-6">Sign in to access your mission dashboard</p>
              <Link
                to="/auth"
